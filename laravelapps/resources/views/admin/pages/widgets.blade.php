 @include('admin.navigasi.atas')
 @include('admin.navigasi.header')
                  ...
                  <div class="box-body">
                    ...
                    <div class="direct-chat-contacts">
                      <ul class="contacts-list">
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" src="{{ asset('AdminLTE/dist/img/user1-128x128.jpgs') }}" alt="User Image">
